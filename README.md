...
[![Release App and Helm Chart](https://github.com/tenaghirmb/kube-cron-restart-controller/actions/workflows/release.yml/badge.svg?branch=main)](https://github.com/tenaghirmb/kube-cron-restart-controller/actions/workflows/release.yml)
...
# 2. Using Repo
helm repo add th-repo https://tenaghirmb.github.io/kube-cron-restart-controller/
helm repo update
helm install cronrestart th-repo/cronrestart
```
